...
<section class="hero-section">
    ...
    <div class="hero-bg-carousel" id="heroBgCarousel">
        <div class="hero-bg-slide active" style="background-image:url('https://images.pexels.com/photos/3756766/pexels-photo-3756766.jpeg?auto=compress&cs=tinysrgb&w=1600')"></div>
        <div class="hero-bg-slide" style="background-image:url('https://images.pexels.com/photos/167636/pexels-photo-167636.jpeg?auto=compress&cs=tinysrgb&w=1600')"></div>
        <div class="hero-bg-slide" style="background-image:url('https://images.pexels.com/photos/1763075/pexels-photo-1763075.jpeg?auto=compress&cs=tinysrgb&w=1600')"></div>
        <div class="hero-bg-slide" style="background-image:url('https://images.pexels.com/photos/1370548/pexels-photo-1370548.jpeg?auto=compress&cs=tinysrgb&w=1600')"></div>
        <div class="hero-bg-slide" style="background-image:url('https://images.pexels.com/photos/2622911/pexels-photo-2622911.jpeg?auto=compress&cs=tinysrgb&w=1600')"></div>
    </div>
    ...
    <div class="lm-carousel-wrapper position-relative">
        ...
        <div class="lm-track" id="lmTrack" data-carousel="latest-music">
            <?php foreach ($latestSongs as $s):
                $img = $s['image_url'] ?: 'https://images.pexels.com/photos/3756766/pexels-photo-3756766.jpeg?auto=compress&cs=tinysrgb&w=600';
                $dur = $s['duration'] ?? '0:00';
    ...
    <div class="lm-carousel-wrapper">
        ...
        <div class="lm-track" id="lvTrack" data-carousel="latest-videos">
            <?php foreach ($latestVideos as $v):
                $img = $v['image_url'] ?: 'https://images.pexels.com/photos/2588657/pexels-photo-2588657.jpeg?auto=compress&cs=tinysrgb&w=600';
                $dur = $v['duration'] ?? '0:00';
    ...
    <div class="fa-section">
        ...
        <div class="fa-grid">
            <?php foreach ($albums as $al):
                $img = $al['image_url'] ?: 'https://images.pexels.com/photos/167636/pexels-photo-167636.jpeg?auto=compress&cs=tinysrgb&w=600';
    ...
    <div class="fart-section">
        ...
        <div class="fart-grid">
            <?php foreach ($artists as $a):
                $img = $a['image_url'] ?: 'https://images.pexels.com/photos/167636/pexels-photo-167636.jpeg?auto=compress&cs=tinysrgb&w=400';
...
<section class="container-fluid px-3 px-lg-4 py-4">
    <div class="bc-section">
        ...
        <div class="bc-grid">
            <?php
            $bcImgs = [
                'https://images.pexels.com/photos/26804072/pexels-photo-26804072.jpeg?auto=compress&cs=tinysrgb&w=500',
                'https://images.pexels.com/photos/14662471/pexels-photo-14662471.jpeg?auto=compress&cs=tinysrgb&w=500',
                'https://images.pexels.com/photos/12662645/pexels-photo-12662645.jpeg?auto=compress&cs=tinysrgb&w=500',
                'https://images.pexels.com/photos/27676345/pexels-photo-27676345.jpeg?auto=compress&cs=tinysrgb&w=500',
                'https://images.pexels.com/photos/13399710/pexels-photo-13399710.jpeg?auto=compress&cs=tinysrgb&w=500',
                'https://images.pexels.com/photos/28678530/pexels-photo-28678530.jpeg?auto=compress&cs=tinysrgb&w=500',
            ];
