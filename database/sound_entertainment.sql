...
('Arijit Singh','Bollywood playback king with a soulful, heart-touching voice.','public/images/artist-arijit.webp'),
('Shreya Ghoshal','Melodious Bollywood playback singer with golden vocals.','public/images/artist-shreya.webp'),
('Atif Aslam','Soulful Hindi rock and Bollywood singer with unmatched depth.','public/images/artist-atif.webp'),
('Neha Kakkar','Energetic Bollywood party singer with chart-topping hits.','public/images/artist-neha.webp'),
('Pritam','Legendary Bollywood music composer behind countless hits.','public/images/artist-pritam.webp'),
('Mohit Chauhan','Soulful indie and Bollywood singer with a unique timbre.','public/images/artist-mohit.webp'),
('Vishal-Shekhar','Dynamic Bollywood music duo creating timeless melodies.','public/images/artist-vishal.webp'),
('A.R. Rahman','Oscar-winning Indian composer who redefined film music.','public/images/artist-ar-rahman.webp'),
('Jubin Nautiyal','Romantic Hindi ballad singer with a velvety voice.','public/images/artist-jubin.webp'),
('Taylor Swift','Global pop superstar with record-breaking albums.','public/images/artist-taylor.webp'),
('Ed Sheeran','Singer-songwriter sensation with heartfelt melodies.','public/images/artist-ed.webp'),
('The Weeknd','R&B and pop icon with a dark, cinematic sound.','public/images/artist-weeknd.webp');

-- 12 albums: 9 Hindi (75%), 3 English (25%)
INSERT INTO albums (title, artist_id, year, image_url) VALUES
('Tum Hi Ho', 1, 2024, 'public/images/album-1.webp'),
...
('Tum Hi Ho','A soulful romantic Hindi ballad that touches the heart.','public/images/song-1.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',1,1,2,1,2024,292,1,8500),
('Chahun Main Ya Na','A beautiful Hindi love song with gentle melodies.','public/images/song-2.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',1,1,2,1,2024,275,0,5200),
('Tera Ban Jaunga','A devotional romantic Hindi song with serene vocals.','public/images/song-3.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3',2,2,2,1,2024,310,1,7800),
('Raabta','A melodious Hindi track about unspoken connections.','public/images/song-4.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3',2,2,2,1,2023,258,0,4100),
('Pehli Nazar Mein','A heart-melting Hindi song about love at first sight.','public/images/song-5.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3',3,3,2,1,2023,287,1,6300),
('Tu Jaane Na','A soulful Hindi ballad about unspoken love.','public/images/song-6.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3',3,3,2,1,2023,312,0,3900),
('London Thumakda','A fun, upbeat Hindi party song full of energy.','public/images/song-7.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3',4,4,2,1,2024,195,1,9200),
('Kala Chashma','A high-energy Hindi dance track that gets everyone moving.','public/images/song-8.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3',4,4,2,1,2024,208,0,6700),
('Phir Le Aya Dil','A soulful Hindi ghazal-inspired romantic track.','public/images/song-9.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3',5,5,2,1,2023,265,0,3400),
('Barfi','A sweet Hindi melody inspired by the mountains.','public/images/song-10.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3',5,5,2,1,2023,232,1,2800),
('Sadda Haq','A powerful Hindi rock anthem about freedom.','public/images/song-11.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3',6,6,3,1,2022,245,0,5600),
('Jo Bheji Thi Dua','A hauntingly beautiful Hindi song about longing.','public/images/song-12.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3',6,6,2,1,2022,298,1,4800),
('Lungi Dance','A fun Hindi tribute song with infectious energy.','public/images/song-13.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3',7,7,2,1,2023,218,0,7200),
('Titli','A gentle Hindi melody celebrating love and butterflies.','public/images/song-14.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3',7,7,2,1,2023,240,1,3600),
('Dil Se Re','An iconic Hindi track bursting with passion and energy.','public/images/song-15.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3',8,8,2,1,2022,282,1,8900),
('Chaiyya Chaiyya','A legendary Hindi song that became a global phenomenon.','public/images/song-16.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3',8,8,2,1,2022,318,0,10500),
('Lut Gaye','A heart-wrenching Hindi romantic ballad.','public/images/song-17.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',9,9,2,1,2024,256,1,6800),
('Tum Hi Aana','A soulful Hindi track about waiting for love.','public/images/song-18.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',9,9,2,1,2024,278,0,4500),
('Anti-Hero','A catchy English pop anthem about self-acceptance.','public/images/song-19.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3',10,10,9,2,2024,200,1,4200),
('Lavender Haze','A dreamy English pop track with atmospheric production.','public/images/song-20.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3',10,10,9,2,2024,215,0,3100),
('Shape of You','A global English hit with an irresistible groove.','public/images/song-21.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3',11,11,9,2,2023,233,1,9500),
('Perfect','A beautiful English love ballad for every romantic moment.','public/images/song-22.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3',11,11,9,2,2023,263,0,5800),
('Blinding Lights','An English synth-pop masterpiece with infectious energy.','public/images/song-23.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3',12,12,9,2,2023,200,1,8200),
('Save Your Tears','An English pop track with a retro 80s vibe.','public/images/song-24.webp','https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3',12,12,9,2,2023,215,0,4900);
...
('Tera Ban Jaunga — Live','A breathtaking live performance of the Hindi devotional romance.','public/images/video-2.webp','https://www.youtube.com/watch?v=e3r-F3omIpA',2,2,1,2024,310,1,8900),
('Pehli Nazar — Lyric Video','Sing along to the soulful Hindi love at first sight track.','public/images/video-3.webp','https://www.youtube.com/watch?v=B5pB1ypb5o8',3,2,1,2023,287,0,6700),
('London Thumakda — Party Video','A high-energy Hindi party video that gets everyone dancing.','public/images/video-4.webp','https://www.youtube.com/watch?v=OqlQ5eVxbX0',4,2,1,2024,195,1,14000),
('Barfi — Music Video','A sweet Hindi melody video shot in beautiful mountain locations.','public/images/video-5.webp','https://www.youtube.com/watch?v=qAezbpTCmBw',5,2,1,2023,232,0,5200),
('Sadda Haq — Rock Video','A powerful Hindi rock anthem video about freedom and rebellion.','public/images/video-6.webp','https://www.youtube.com/watch?v=IjFzPYo8LCc',6,3,1,2022,245,1,7800),
('Lungi Dance — Dance Video','The viral Hindi tribute dance video with infectious choreography.','public/images/video-7.webp','https://www.youtube.com/watch?v=69CEiHfS_mc',7,2,1,2023,218,0,9500),
('Dil Se Re — Classic Video','The iconic Hindi music video that defined a generation.','public/images/video-8.webp','https://www.youtube.com/watch?v=MYfaX0BH2AY',8,2,1,2022,282,1,11000),
('Lut Gaye — Romantic Video','A heart-wrenching Hindi romantic video that went viral.','public/images/video-9.webp','https://www.youtube.com/watch?v=5-sfG8BTfps',9,2,1,2024,256,1,8500),
('Anti-Hero — Official Video','The colorful English pop music video for the chart-topping hit.','public/images/video-10.webp','https://www.youtube.com/watch?v=b1kbLwvqugk',10,9,2,2024,200,1,6500),
('Shape of You — Music Video','The global English hit video that broke all streaming records.','public/images/video-11.webp','https://www.youtube.com/watch?v=JGwWNGJdvx8',11,9,2,2023,233,0,9800),
('Blinding Lights — Visualizer','A neon-soaked English visualizer for the synth-pop masterpiece.','public/images/video-12.webp','https://www.youtube.com/watch?v=4NRXx6U8ABQ',12,9,2,2023,200,1,7200);
